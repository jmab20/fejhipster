package es.tecsidel.fejhipster.config;

import es.tecsidel.fejhipster.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("es.tecsidel.fejhipster.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("es.tecsidel.fejhipster.repository.search")
