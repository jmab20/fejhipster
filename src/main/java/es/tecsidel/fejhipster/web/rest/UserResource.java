package es.tecsidel.fejhipster.web.rest;

import com.codahale.metrics.annotation.Timed;
import es.tecsidel.fejhipster.domain.Authority;
import es.tecsidel.fejhipster.domain.User;
import es.tecsidel.fejhipster.repository.AuthorityRepository;
import es.tecsidel.fejhipster.repository.UserRepository;
import es.tecsidel.fejhipster.repository.search.UserSearchRepository;
import es.tecsidel.fejhipster.security.AuthoritiesConstants;
import es.tecsidel.fejhipster.service.MailService;
import es.tecsidel.fejhipster.service.UserService;
import es.tecsidel.fejhipster.web.rest.dto.ManagedUserDTO;
import es.tecsidel.fejhipster.web.rest.dto.UserDTO;
import es.tecsidel.fejhipster.web.rest.util.HeaderUtil;
import es.tecsidel.fejhipster.web.rest.util.PaginationUtil;
